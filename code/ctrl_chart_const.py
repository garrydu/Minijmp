...
data = {
    ...
    'd3': [0.8525, 0.8884, 0.8798, 0.8798, 0.8480, 0.8332, 0.8198, 0.8078, 0.7971, 0.7873, 0.7785, 0.7704, 0.7630, 0.7562, 0.7499, 0.7441, 0.7386, 0.7335, 0.7287, 0.7272, 0.7199, 0.7159, 0.7121, 0.7084],
    ...
    'D4': [3.267, 2.574, 2.282, 2.114, 2.004, 1.924, 1.864, 1.816, 1.777, 1.744, 1.717, 1.693, 1.672, 1.653, 1.637, 1.622, 1.607, 1.597, 1.585, 1.575, 1.566, 1.557, 1.548, 1.541],
...
numeric_columns = ['n', 'd2', 'd3', 'C4', 'A2', 'D3', 'D4', 'A3', 'B3', 'B4']
